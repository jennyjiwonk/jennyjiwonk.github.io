...
<!--
  ...
  front matter above, which broke Jekyll's front matter parsing — Jekyll only reads
  front matter when the file's very first line is "---", so this post's real date/
  inline settings were silently ignored and it wasn't showing up in the news list.
